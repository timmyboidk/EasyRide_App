...
class ServiceSelectionVerificationTests: XCTestCase {

    func testServiceSelectionInterfaceImplementation() {
        ...
        XCTAssertEqual(allCases.count, 4, "Should have 4 service types")
        ...
        for type in ServiceType.allCases {
            ...
            XCTAssertGreaterThan(type.basePrice, 0)
        }
